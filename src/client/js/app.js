function updateUI(res) {
    ...
    document.getElementById("temp").innerHTML = res.temperature + "&deg;C";
    document.getElementById("weather").innerHTML = res.weather;
    document.getElementById("apparentTemp").innerHTML = "Feels like: " + res.apparentTemp + "&deg;C";
    document.getElementById("uv").innerHTML = "UV index: " + res.uvIndex + " of 10";
    document.getElementById("aqi").innerHTML = "Air Quality Index: " + res.airQuality + " /500";
...
function setCountdown() {
    ...
    const x = setInterval(() => {
        ...
        document.getElementById("countdown").innerHTML = `Get ready to travel in ${days} and ${hours} hours. Enjoy your ${end} day vacation!`;
